    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          {" "}
          {/* my added recipe for omelette */}
          <li>Cut all vegetables.</li>
          <li>Mix all tthe eggs.</li>
          <li>Add on pan an flip to make omellete.</li>
        </ol>
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-teslabot" src="/web1_Starship-gap2.jpg" height="200px" />
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
